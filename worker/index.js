// worker/index.js
import { Router } from 'itty-router'; // 如果你不想用外部 lib，直接使用 if/else 路由也可以
...
if (!body || !body.lineId) return new Response(JSON.stringify({message:'missing lineId'}), {status:400});
